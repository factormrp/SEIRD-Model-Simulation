...
if __name__ == "__main__":
    ...
    # plot results
    plot_compare(tested,e,t,title="Exposed Population over Time")
    plot_compare(confirmed,i,t,title="Infected Population over Time")
    plot_compare(recovered,r,t,title="Recovered Population over Time")
    plot_compare(deceased,d,t,title="Deceased Population over Time")